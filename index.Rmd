...
```{r figchunk11,fig.dim=c(6,7),fig.cap="Boxplot of Wards-linkage HC (Jaccard)",message=TRUE, warning=TRUE}
...
```{r figchunk12,fig.dim=c(6,7),fig.cap = "Boxplot of Average-linkage HC (Jaccard)", message=TRUE, warning=TRUE}
